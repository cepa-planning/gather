...
Rails.application.configure do
  ...
  config.hosts << 'gather.cepa-planning.coop'
  config.hosts << '74.208.93.250' 
  ...
  config.action_mailer.default_url_options = { host: "gather.cepa-planning.coop" }
  config.action_mailer.delivery_method = :smtp
  config.action_mailer.perform_deliveries = true
  config.action_mailer.raise_delivery_errors = true
  config.action_mailer.default_options = { from: "cepa@cepa-planning.com" }
